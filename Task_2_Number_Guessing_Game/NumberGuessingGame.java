...
public class NumberGuessingGame {
    ...
    public void menu(ArrayList<Integer> scoreBoard) {
        ...
        System.out.println("3] Exit the games");
        System.out.println("--------------------");

        try {
            System.out.print("What action would you like to Perform from above options ? ");
    ...
    public void guessNumber(int randomNumber) {
        ...
        System.out.println(" ");
        if (guess == 1) {
            System.out.println("You answered number is CORRECT in " + guess + " try!");
        } else {
            System.out.println("You answered number is CORRECT in " + guess + " tries!");
        }
